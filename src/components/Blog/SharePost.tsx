  ...
  return (
    <div className="rounded-md bg-white p-6 shadow-md dark:bg-gray-dark">
      ...
      <div className="mt-6 flex items-center">
        <span className="mr-4 text-sm font-medium text-sycom-body">
          Share On:
        </span>
        <div className="flex items-center">
          <a
            ...
            className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xs bg-gray-light text-body-color duration-300 hover:bg-sycom-primary hover:text-white dark:bg-gray-dark dark:hover:bg-sycom-primary sm:ml-3"
          >
            <svg
              width="16"
              height="16"
          ...
          <a
            href="#0"
            aria-label="social-share"
            className="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-xs bg-gray-light text-body-color duration-300 hover:bg-sycom-primary hover:text-white dark:bg-gray-dark dark:hover:bg-sycom-primary"
          >
            <svg
              width="18"
              height="18"
